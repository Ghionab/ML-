...
# Get the active experiment tracker from ZenML if available
try:
    experiment_tracker = Client().active_stack.experiment_tracker
    step_decorator_kwargs = {
        "enable_cache": False,
        "experiment_tracker": experiment_tracker.name,
        "model": model
    }
except (AttributeError, KeyError):
    # Fallback if experiment tracker is not available
    step_decorator_kwargs = {
        "enable_cache": False,
        "model": model
    }

@step(**step_decorator_kwargs)
